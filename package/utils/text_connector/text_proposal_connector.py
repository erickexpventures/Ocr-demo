...
from package.utils.text_connector.other import clip_boxes
from package.utils.text_connector.text_proposal_graph_builder import TextProposalGraphBuilder
